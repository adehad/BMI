...
% model parameters: mean xTrain, weights and selected neurons, cluster centres
function [modelParameters] = positionEstimatorTraining(training_data)
% Arguments:
...
[W, neuronSel, neuronPref] = popCodingTrain(training_data);
...
tBeginTarget = 1; tEndTarget = 300;
[predAngle] = testAngleClassification(test_data, tBeginTarget, tEndTarget, modelParameters.clusterCentres, modelParameters.trainCentre);
...
function [W, neuronSel, neuronPref] = popCodingTrain(trial)
